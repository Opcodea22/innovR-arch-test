...
# Design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_13 processing_system7_vip_v1_0_15 xil_defaultlib xlconcat_v2_1_4)
...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../imgInPL.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../imgInPL.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
       +incdir+"../../../../imgInPL.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../imgInPL.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
